...
class Validator{
    ...
    public function get_readable_errors($convert_to_string = false, $field_class = 'gump-field', $error_class = 'gump-error-message')
    {
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                case 'mismatch' :
                    $resp[] = "There is no validation rule for <span style='' class=\"$field_class\">$field</span> <br>";
                    break;
                case 'validate_required' :
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field is required <br>";
                    break;
                case 'validate_valid_email':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field is required to be a valid email address <br>";
                    break;
                case 'validate_max_len':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to be $param or shorter in length <br>";
                    break;
                case 'validate_min_len':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to be $param or longer in length <br>";
                    break;
                case 'validate_exact_len':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to be exactly $param characters in length <br>";
                    break;
                case 'validate_alpha':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field may only contain alpha characters(a-z) <br>";
                    break;
                case 'validate_alpha_numeric':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field may only contain alpha-numeric characters <br>" ;
                    break;
                case 'validate_alpha_dash':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field may only contain alpha characters &amp; dashes <br>";
                    break;
                case 'validate_numeric':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field may only contain numeric characters <br>";
                    break;
                case 'validate_integer':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field may only contain a numeric value <br>";
                    break;
                case 'validate_boolean':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field may only contain a true or false value <br>";
                    break;
                case 'validate_float':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field may only contain a float value <br>";
                    break;
                case 'validate_valid_url':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field is required to be a valid URL <br>";
                    break;
                case 'validate_url_exists':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> URL does not exist <br>";
                    break;
                case 'validate_valid_ip':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to contain a valid IP address <br>";
                    break;
                case 'validate_valid_cc':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to contain a valid credit card number <br>";
                    break;
                case 'validate_valid_name':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to contain a valid human name <br>";
                    break;
                case 'validate_contains':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to contain one of these values: ".implode(', ', $param)."<br>";
                    break;
                case 'validate_contains_list':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to contain a value from its drop down list <br>";
                    break;
                case 'validate_doesnt_contain_list':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field contains a value that is not accepted <br>";
                    break;
                case 'validate_street_address':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to be a valid street address <br>";
                    break;
                case 'validate_date':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to be a valid date <br>";
                    break;
                case 'validate_min_numeric':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to be a numeric value, equal to, or higher than $param <br>";
                    break;
                case 'validate_max_numeric':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to be a numeric value, equal to, or lower than $param <br>";
                    break;
                case 'validate_starts':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to start with $param <br>";
                    break;
                case 'validate_extension':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field can have the following extensions $param <br>";
                    break;
                case 'validate_required_file':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field is required <br>";
                    break;
                case 'validate_equalsfield':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field does not equal $param field <br>";
                    break;
                case 'validate_min_age':
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field needs to have an age greater than or equal to $param <br>";
                    break;
                default:
                    $resp[] = "The <span style='' class=\"$field_class\">$field</span> field is invalid <br>";
            }
        }
        ...
        if (!$convert_to_string) {
            ...
            $buffer = '';
            foreach ($resp as $s) {
                $buffer .= "<span style='' class=\"$error_class\">* $s</span> <br>";
            }
    ...
    public function get_errors_array($convert_to_string = null)
    {
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                case 'mismatch' :
                    $resp[$field] = "There is no validation rule for $field <br>";
                    break;
                case 'validate_required':
                    $resp[$field] = "The $field field is required <br>";
                    break;
                case 'validate_valid_email':
                    $resp[$field] = "The $field field is required to be a valid email address <br>";
                    break;
                case 'validate_max_len':
                    $resp[$field] = "The $field field needs to be $param or shorter in length <br>";
                    break;
                case 'validate_min_len':
                    $resp[$field] = "The $field field needs to be $param or longer in length <br>";
                    break;
                case 'validate_exact_len':
                    $resp[$field] = "The $field field needs to be exactly $param characters in length <br>";
                    break;
                case 'validate_alpha':
                    $resp[$field] = "The $field field may only contain alpha characters(a-z) <br>";
                    break;
                case 'validate_alpha_numeric':
                    $resp[$field] = "The $field field may only contain alpha-numeric characters <br>";
                    break;
                case 'validate_alpha_dash':
                    $resp[$field] = "The $field field may only contain alpha characters &amp; dashes <br>";
                    break;
                case 'validate_numeric':
                    $resp[$field] = "The $field field may only contain numeric characters <br>";
                    break;
                case 'validate_integer':
                    $resp[$field] = "The $field field may only contain a numeric value <br>";
                    break;
                case 'validate_boolean':
                    $resp[$field] = "The $field field may only contain a true or false value <br>";
                    break;
                case 'validate_float':
                    $resp[$field] = "The $field field may only contain a float value <br>";
                    break;
                case 'validate_valid_url':
                    $resp[$field] = "The $field field is required to be a valid URL <br>";
                    break;
                case 'validate_url_exists':
                    $resp[$field] = "The $field URL does not exist <br>";
                    break;
                case 'validate_valid_ip':
                    $resp[$field] = "The $field field needs to contain a valid IP address <br>";
                    break;
                case 'validate_valid_cc':
                    $resp[$field] = "The $field field needs to contain a valid credit card number <br>";
                    break;
                case 'validate_valid_name':
                    $resp[$field] = "The $field field needs to contain a valid human name <br>";
                    break;
                case 'validate_contains':
                    $resp[$field] = "The $field field needs to contain one of these values: ".implode(', ', $param)."<br>";
                    break;
                case 'validate_contains_list':
                    $resp[$field] = "The $field field needs to contain a value from its drop down list <br>";
                    break;
                case 'validate_doesnt_contain_list':
                    $resp[$field] = "The $field field contains a value that is not accepted <br>";
                    break;
                case 'validate_street_address':
                    $resp[$field] = "The $field field needs to be a valid street address <br>";
                    break;
                case 'validate_date':
                    $resp[$field] = "The $field field needs to be a valid date <br>";
                    break;
                case 'validate_min_numeric':
                    $resp[$field] = "The $field field needs to be a numeric value, equal to, or higher than $param <br>";
                    break;
                case 'validate_max_numeric':
                    $resp[$field] = "The $field field needs to be a numeric value, equal to, or lower than $param <br>";
                    break;
                case 'validate_min_age':
                    $resp[$field] = "The $field field needs to have an age greater than or equal to $param <br>";
                    break;
                default:
                    $resp[$field] = "The $field field is invalid <br>";
            }
        }
    ...
    */
    ...
    /*
    * Field Error
    * Usage field_error($field_name,$errorvar)
    * @param field name
    * @param errorVar <array>
    */
    public static function field_error($fieldName,$errorVar,$custom_message=NULL){
        
        if(!empty($errorVar)){

        foreach($errorVar as $field_error){

                if(strpos($fieldName, "_") || strpos($fieldName, "-") ){
                ...
                if(strpos($field_error, ucwords($fieldName))!==FALSE)
                {
